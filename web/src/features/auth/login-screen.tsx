...
export function LoginScreen() {
  ...
  return (
    <main className="auth-mobile-page relative h-[100svh] overflow-y-auto bg-[#f7f9f8] text-[#0f172a] lg:h-screen lg:overflow-hidden">
          ...
          >
            ...
            >
              <div className="max-w-[620px]">
                ...
                <p className={cn(
                  "max-w-[580px] text-base leading-7 text-[#58667a] lg:text-[clamp(0.95rem,1vw,1.08rem)]",
                  dense ? "mt-2 text-sm leading-5 lg:mt-1.5 lg:line-clamp-1" : "mt-3 lg:mt-[clamp(0.65rem,1.4vh,1rem)]",
                )}>
                ...
                >
                  <div className={cn("grid", dense ? "gap-3" : "gap-4 lg:gap-[clamp(0.7rem,1.4vh,1rem)]")}>
                    <Field
                      id="auth-email"
                      label="浙大邮箱"
                      icon={Mail}
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        dense ? "h-12 text-base" : "h-[3.25rem] min-h-[3.25rem] text-lg lg:h-[clamp(3rem,5.2vh,3.6rem)]",
                      )}
                    >
